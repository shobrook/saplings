...
class Config(object):
    GEN_THOUGHTS_MODEL = LLMs.GPT_35_TURBO_16K
    EVAL_STATE_MODEL = LLMs.GPT_35_TURBO_16K
    SEARCH_ALGO = SearchAlgorithms.BREADTH_FIRST




GENERATE_THOUGHTS_PROMPT = """
Consider the reasoning below:
